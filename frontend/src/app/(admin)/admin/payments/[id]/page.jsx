...
function Page() {
  ...
  return (
    <div className="space-y-8">
      <p>
        <strong>invoice number :</strong> {paymentt.invoiceNumber}
      </p>
      <p>
        <strong>payment method :</strong> {paymentt.paymentMethod}
      </p>
      <p>
      ...
      <p>
        ...
        <span className={`${paymentt.status == "COMPLETED" && "text-success"}`}>
          {paymentt.status.toLocaleLowerCase()}
        </span>
      </p>
      ...
      <p>
        <strong>paied price :</strong> {paymentt.amount}
      </p>
      <p>
        <strong>products :</strong>{" "}
      </p>
      <div className="flex flex-wrap items-center gap-3">
        {paymentt.cart.productDetail.map((item) => (
