...
function Page() {
  ...
  return (
    <div className="space-y-7">
      <div>
        <IoMdPerson className="text-primary-900 w-9 h-9" />
      </div>
      <p>
      ...
      <p className="flex items-center gap-0.5">
        <span className="font-bold">verified phone number:</span>
        {data.user.isVerifiedPhoneNumber ? (
          <IoIosCheckmarkCircleOutline className="w-6 h-6 text-green-900" />
        ) : (
          <IoMdCloseCircleOutline className="w-6 h-6 text-red-900" />
        )}
      </p>
      <p>
